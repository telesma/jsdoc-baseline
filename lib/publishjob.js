...
PublishJob.prototype.setNavTree = function(navTree) {
    this.navTree = navTree;

    return this;
};

PublishJob.prototype.setAllLongnamesTree = function(allLongnamesTree) {
...
PublishJob.prototype.generateTocData = function(options) {
...
PublishJob.prototype.generateGlobals = function(globalSymbols) {
    var data;
    var title = this.template.translate('headings.' + CATEGORIES.GLOBALS,
...
PublishJob.prototype.generateIndex = function(readme) {
    var data = {
